 ...
 * C source code generated on : Sat Oct 13 18:14:22 2018
 *
 ...
 */
#ifndef RTW_HEADER_oppgave_3_h_
#define RTW_HEADER_oppgave_3_h_
#include <string.h>
#ifndef oppgave_3_COMMON_INCLUDES_
# define oppgave_3_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* oppgave_3_COMMON_INCLUDES_ */

#include "oppgave_3_types.h"
...
#define oppgave_3_rtModel              RT_MODEL_oppgave_3_T
...
#define rtB                            oppgave_3_B
#define BlockIO                        B_oppgave_3_T
#define rtX                            oppgave_3_X
#define ContinuousStates               X_oppgave_3_T
#define rtXdot                         oppgave_3_XDot
#define StateDerivatives               XDot_oppgave_3_T
#define tXdis                          oppgave_3_XDis
#define StateDisabled                  XDis_oppgave_3_T
#define rtP                            oppgave_3_P
#define Parameters                     P_oppgave_3_T
#define rtDWork                        oppgave_3_DW
#define D_Work                         DW_oppgave_3_T

/* Parameters (auto storage) */
struct P_oppgave_3_T_ {
...
extern P_oppgave_3_T oppgave_3_P;

/* Block signals (auto storage) */
extern B_oppgave_3_T oppgave_3_B;

/* Continuous states (auto storage) */
extern X_oppgave_3_T oppgave_3_X;

/* Block states (auto storage) */
extern DW_oppgave_3_T oppgave_3_DW;
...
extern void oppgave_3_initialize(void);
extern void oppgave_3_output0(void);
extern void oppgave_3_update0(void);
extern void oppgave_3_output(int_T tid);
extern void oppgave_3_update(int_T tid);
extern void oppgave_3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_oppgave_3_T *const oppgave_3_M;
 ...
 *
 * '<Root>' : 'oppgave_3'
 * '<S1>'   : 'oppgave_3/Conversion'
 * '<S2>'   : 'oppgave_3/Heli 3D'
 * '<S3>'   : 'oppgave_3/Joystick'
 * '<S4>'   : 'oppgave_3/LQR'
 * '<S5>'   : 'oppgave_3/Heli 3D/Degrees to Radians'
 * '<S6>'   : 'oppgave_3/Heli 3D/Degrees to Radians1'
 * '<S7>'   : 'oppgave_3/Heli 3D/Degrees to Radians2'
 * '<S8>'   : 'oppgave_3/Heli 3D/Degrees to Radians3'
 * '<S9>'   : 'oppgave_3/Heli 3D/Degrees to Radians4'
 * '<S10>'  : 'oppgave_3/Heli 3D/Degrees to Radians5'
 * '<S11>'  : 'oppgave_3/Heli 3D/Elevation rad to deg'
 * '<S12>'  : 'oppgave_3/Heli 3D/Elevation rate rad to deg'
 * '<S13>'  : 'oppgave_3/Heli 3D/Pitch rad to deg'
 * '<S14>'  : 'oppgave_3/Heli 3D/Pitch rate rad to deg'
 * '<S15>'  : 'oppgave_3/Heli 3D/Travel rad to deg'
 * '<S16>'  : 'oppgave_3/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_oppgave_3_h_ */
