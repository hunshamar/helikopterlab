...
MODEL                = oppgave_3
MODULES              = oppgave_3_data.c oppgave_3_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = oppgave_3.mk
...
MODELLIB                  = oppgave_3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = oppgave_3_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)oppgave_3_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)simulinker
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:
