 ...
 */
#ifndef RTW_HEADER_oppgave_2_s_h_
#define RTW_HEADER_oppgave_2_s_h_
#include <string.h>
#ifndef oppgave_2_s_COMMON_INCLUDES_
# define oppgave_2_s_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* oppgave_2_s_COMMON_INCLUDES_ */

#include "oppgave_2_s_types.h"
...
#define oppgave_2_s_rtModel            RT_MODEL_oppgave_2_s_T
...
#define rtB                            oppgave_2_s_B
#define BlockIO                        B_oppgave_2_s_T
#define rtX                            oppgave_2_s_X
#define ContinuousStates               X_oppgave_2_s_T
#define rtXdot                         oppgave_2_s_XDot
#define StateDerivatives               XDot_oppgave_2_s_T
#define tXdis                          oppgave_2_s_XDis
#define StateDisabled                  XDis_oppgave_2_s_T
#define rtP                            oppgave_2_s_P
#define Parameters                     P_oppgave_2_s_T
#define rtDWork                        oppgave_2_s_DW
#define D_Work                         DW_oppgave_2_s_T

/* Parameters (auto storage) */
struct P_oppgave_2_s_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T KrpK_3_Gain;                  /* Expression: -1
                                        * Referenced by: '<S7>/KrpK_3'
                                        */
  real_T Kpp_Gain;                     /* Expression: 10
                                        * Referenced by: '<S6>/Kpp '
                                        */
  real_T Kpd_Gain;                     /* Expression: 19
                                        * Referenced by: '<S6>/Kpd '
                                        */
...
extern P_oppgave_2_s_T oppgave_2_s_P;

/* Block signals (auto storage) */
extern B_oppgave_2_s_T oppgave_2_s_B;

/* Continuous states (auto storage) */
extern X_oppgave_2_s_T oppgave_2_s_X;

/* Block states (auto storage) */
extern DW_oppgave_2_s_T oppgave_2_s_DW;
...
extern void oppgave_2_s_initialize(void);
extern void oppgave_2_s_output0(void);
extern void oppgave_2_s_update0(void);
extern void oppgave_2_s_output(int_T tid);
extern void oppgave_2_s_update(int_T tid);
extern void oppgave_2_s_terminate(void);

/* Real-time Model object */
extern RT_MODEL_oppgave_2_s_T *const oppgave_2_s_M;
 ...
 *
 * '<Root>' : 'oppgave_2_s'
 * '<S1>'   : 'oppgave_2_s/Conversion'
 * '<S2>'   : 'oppgave_2_s/Degrees to Radians'
 * '<S3>'   : 'oppgave_2_s/Elevation controller'
 * '<S4>'   : 'oppgave_2_s/Heli 3D'
 * '<S5>'   : 'oppgave_2_s/Joystick'
 * '<S6>'   : 'oppgave_2_s/Pitch controller'
 * '<S7>'   : 'oppgave_2_s/travel controller '
 * '<S8>'   : 'oppgave_2_s/Elevation controller/Elevation controller'
 * '<S9>'   : 'oppgave_2_s/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'oppgave_2_s/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'oppgave_2_s/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'oppgave_2_s/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'oppgave_2_s/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'oppgave_2_s/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_oppgave_2_s_h_ */
