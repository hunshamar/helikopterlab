 ...
 */
#ifndef RTW_HEADER_Oppgave_4_fml_h_
#define RTW_HEADER_Oppgave_4_fml_h_
#include <stddef.h>
#include <string.h>
#ifndef Oppgave_4_fml_COMMON_INCLUDES_
# define Oppgave_4_fml_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Oppgave_4_fml_COMMON_INCLUDES_ */

#include "Oppgave_4_fml_types.h"
...
#define Oppgave_4_fml_rtModel          RT_MODEL_Oppgave_4_fml_T

/* Block signals (auto storage) */
typedef struct {
  real_T Integrator2[6];               /* '<S5>/Integrator2' */
  ...
  real_T Gain_p;                       /* '<S17>/Gain' */
  real_T Gain1;                        /* '<S7>/Gain1' */
  real_T Gain1_g;                      /* '<S9>/Gain1' */
  ...
  real_T Sum2;                         /* '<S4>/Sum2' */
  real_T Sum1_d;                       /* '<S4>/Sum1' */
  real_T Sum1_j[6];                    /* '<S5>/Sum1' */
} B_Oppgave_4_fml_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ElevationrateScopedegs_PWORK;      /* '<S2>/Elevation rate: Scope [deg//s]' */
...
typedef struct {
  real_T Integrator2_CSTATE[6];        /* '<S5>/Integrator2' */
  real_T Integrator1_CSTATE;           /* '<S4>/Integrator1' */
  real_T Integrator2_CSTATE_l;         /* '<S4>/Integrator2' */
...
typedef struct {
  ...
  real_T PitchTransferFcn_CSTATE;      /* '<S2>/Pitch: Transfer Fcn' */
  real_T TravelTransferFcn_CSTATE;     /* '<S2>/Travel: Transfer Fcn' */
} XDot_Oppgave_4_fml_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator2_CSTATE[6];     /* '<S5>/Integrator2' */
  boolean_T Integrator1_CSTATE;        /* '<S4>/Integrator1' */
  boolean_T Integrator2_CSTATE_l;      /* '<S4>/Integrator2' */
...
#define rtB                            Oppgave_4_fml_B
#define BlockIO                        B_Oppgave_4_fml_T
#define rtX                            Oppgave_4_fml_X
#define ContinuousStates               X_Oppgave_4_fml_T
#define rtXdot                         Oppgave_4_fml_XDot
#define StateDerivatives               XDot_Oppgave_4_fml_T
#define tXdis                          Oppgave_4_fml_XDis
#define StateDisabled                  XDis_Oppgave_4_fml_T
#define rtP                            Oppgave_4_fml_P
#define Parameters                     P_Oppgave_4_fml_T
#define rtDWork                        Oppgave_4_fml_DW
#define D_Work                         DW_Oppgave_4_fml_T

/* Parameters (auto storage) */
struct P_Oppgave_4_fml_T_ {
  real_T A_L[36];                      /* Variable: A_L
                                        * Referenced by: '<S5>/K 1'
                                        */
  real_T B_L[12];                      /* Variable: B_L
                                        * Referenced by: '<S5>/K 4'
                                        */
  real_T C_L[18];                      /* Variable: C_L
                                        * Referenced by:
                                        *   '<S5>/K 2'
                                        *   '<S5>/K 3'
                                        */
  ...
  real_T Integrator2_IC;               /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 6.5
  ...
  real_T Gain_Gain_l;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T Constant_Value_d;             /* Expression: -30
...
struct tag_RTM_Oppgave_4_fml_T {
  const char_T *path;
...
extern P_Oppgave_4_fml_T Oppgave_4_fml_P;

/* Block signals (auto storage) */
extern B_Oppgave_4_fml_T Oppgave_4_fml_B;

/* Continuous states (auto storage) */
extern X_Oppgave_4_fml_T Oppgave_4_fml_X;

/* Block states (auto storage) */
extern DW_Oppgave_4_fml_T Oppgave_4_fml_DW;
...
extern void Oppgave_4_fml_initialize(void);
extern void Oppgave_4_fml_output0(void);
extern void Oppgave_4_fml_update0(void);
extern void Oppgave_4_fml_output(int_T tid);
extern void Oppgave_4_fml_update(int_T tid);
extern void Oppgave_4_fml_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Oppgave_4_fml_T *const Oppgave_4_fml_M;
 ...
 *
 * '<Root>' : 'Oppgave_4_fml'
 * '<S1>'   : 'Oppgave_4_fml/Conversion'
 * '<S2>'   : 'Oppgave_4_fml/Heli 3D'
 * '<S3>'   : 'Oppgave_4_fml/Joystick'
 * '<S4>'   : 'Oppgave_4_fml/LQR'
 * '<S5>'   : 'Oppgave_4_fml/Observer'
 * '<S6>'   : 'Oppgave_4_fml/rearrangement of states'
 * '<S7>'   : 'Oppgave_4_fml/Heli 3D/Degrees to Radians'
 * '<S8>'   : 'Oppgave_4_fml/Heli 3D/Degrees to Radians1'
 * '<S9>'   : 'Oppgave_4_fml/Heli 3D/Degrees to Radians2'
 * '<S10>'  : 'Oppgave_4_fml/Heli 3D/Degrees to Radians3'
 * '<S11>'  : 'Oppgave_4_fml/Heli 3D/Degrees to Radians4'
 * '<S12>'  : 'Oppgave_4_fml/Heli 3D/Degrees to Radians5'
 * '<S13>'  : 'Oppgave_4_fml/Heli 3D/Elevation rad to deg'
 * '<S14>'  : 'Oppgave_4_fml/Heli 3D/Elevation rate rad to deg'
 * '<S15>'  : 'Oppgave_4_fml/Heli 3D/Pitch rad to deg'
 * '<S16>'  : 'Oppgave_4_fml/Heli 3D/Pitch rate rad to deg'
 * '<S17>'  : 'Oppgave_4_fml/Heli 3D/Travel rad to deg'
 * '<S18>'  : 'Oppgave_4_fml/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_Oppgave_4_fml_h_ */
