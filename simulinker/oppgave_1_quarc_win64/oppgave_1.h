 ...
 */
#ifndef RTW_HEADER_oppgave_1_h_
#define RTW_HEADER_oppgave_1_h_
#include <string.h>
#ifndef oppgave_1_COMMON_INCLUDES_
# define oppgave_1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* oppgave_1_COMMON_INCLUDES_ */

#include "oppgave_1_types.h"
...
#define oppgave_1_rtModel              RT_MODEL_oppgave_1_T
...
#define rtB                            oppgave_1_B
#define BlockIO                        B_oppgave_1_T
#define rtX                            oppgave_1_X
#define ContinuousStates               X_oppgave_1_T
#define rtXdot                         oppgave_1_XDot
#define StateDerivatives               XDot_oppgave_1_T
#define tXdis                          oppgave_1_XDis
#define StateDisabled                  XDis_oppgave_1_T
#define rtP                            oppgave_1_P
#define Parameters                     P_oppgave_1_T
#define rtDWork                        oppgave_1_DW
#define D_Work                         DW_oppgave_1_T

/* Parameters (auto storage) */
struct P_oppgave_1_T_ {
...
extern P_oppgave_1_T oppgave_1_P;

/* Block signals (auto storage) */
extern B_oppgave_1_T oppgave_1_B;

/* Continuous states (auto storage) */
extern X_oppgave_1_T oppgave_1_X;

/* Block states (auto storage) */
extern DW_oppgave_1_T oppgave_1_DW;
...
extern void oppgave_1_initialize(void);
extern void oppgave_1_output0(void);
extern void oppgave_1_update0(void);
extern void oppgave_1_output(int_T tid);
extern void oppgave_1_update(int_T tid);
extern void oppgave_1_terminate(void);

/* Real-time Model object */
extern RT_MODEL_oppgave_1_T *const oppgave_1_M;
 ...
 *
 * '<Root>' : 'oppgave_1'
 * '<S1>'   : 'oppgave_1/Conversion'
 * '<S2>'   : 'oppgave_1/Elevation controller'
 * '<S3>'   : 'oppgave_1/Heli 3D'
 * '<S4>'   : 'oppgave_1/Joystick'
 * '<S5>'   : 'oppgave_1/Pitch controller'
 * '<S6>'   : 'oppgave_1/Elevation controller/Elevation controller'
 * '<S7>'   : 'oppgave_1/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'oppgave_1/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'oppgave_1/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'oppgave_1/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'oppgave_1/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'oppgave_1/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_oppgave_1_h_ */
