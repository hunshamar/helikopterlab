...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ElevationrateScopedegs_PWORK;      /* '<S3>/Elevation rate: Scope [deg//s]' */
...
struct P_heli_q8_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Constant_Value;               /* Expression: 6.25
  ...
  real_T Gain1_Gain_p;                 /* Expression: 2
                                        ...
                                        */
  real_T KrpK_3_Gain;                  /* Expression: 0.5
                                        * Referenced by: '<S6>/KrpK_3'
                                        */
  ...
  real_T Gain_Gain_a;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T Gain1_Gain_pb;                /* Expression: pi/180
                                        * Referenced by: '<S10>/Gain1'
                                        */
  real_T Kpp_Gain;                     /* Expression: 30
  ...
  real_T Gain1_Gain_k;                 /* Expression: pi/180
                                        ...
                                        */
  real_T Kpd_Gain;                     /* Expression: 7.5
  ...
  real_T Gain_Gain_e;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T Constant_Value_n;             /* Expression: -30
 ...
 * '<S8>'   : 'heli_q8/Heli 3D/Degrees to Radians'
 * '<S9>'   : 'heli_q8/Heli 3D/Degrees to Radians1'
 * '<S10>'  : 'heli_q8/Heli 3D/Degrees to Radians2'
 * '<S11>'  : 'heli_q8/Heli 3D/Degrees to Radians3'
 * '<S12>'  : 'heli_q8/Heli 3D/Degrees to Radians4'
 * '<S13>'  : 'heli_q8/Heli 3D/Degrees to Radians5'
