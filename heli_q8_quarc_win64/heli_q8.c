 ...
 * C source code generated on : Sat Oct 13 18:38:33 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_DeadZonex = heli_q8_DW.HILReadEncoderTimebase_Buffer[0];
    ...
    heli_q8_B.TravelCounttorad = heli_q8_P.TravelCounttorad_Gain * rtb_DeadZonex;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/Gain1' */
    heli_q8_B.Gain1 = heli_q8_P.Gain1_Gain_p * heli_q8_B.Joystick_gain_x;
     ...
     *  Gain: '<S16>/Gain'
     */
    heli_q8_B.Sum1 = heli_q8_P.Gain_Gain_a * heli_q8_B.PitchCounttorad -
      heli_q8_P.Constant1_Value_a;

    /* Gain: '<S10>/Gain1' */
    heli_q8_B.Gain1_d = heli_q8_P.Gain1_Gain_pb * heli_q8_B.Sum1;
  }
   ...
   */
  heli_q8_B.Gain_c = (heli_q8_P.PitchTransferFcn_C *
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Sum1 = ((heli_q8_P.Gain1_Gain * heli_q8_B.Gain - heli_q8_B.Gain1) *
              heli_q8_P.KrpK_3_Gain - heli_q8_B.Gain1_d) * heli_q8_P.Kpp_Gain -
    heli_q8_P.Gain1_Gain_k * heli_q8_B.Gain_c * heli_q8_P.Kpd_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<S14>/Gain'
     */
    heli_q8_B.Sum = heli_q8_P.Gain_Gain_e * heli_q8_B.ElevationCounttorad +
      heli_q8_P.Constant_Value_n;

    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<Root>/Constant1'
     *  Gain: '<S8>/Gain1'
     */
    rtb_DeadZoney = heli_q8_P.Constant1_Value - heli_q8_P.Gain1_Gain_f *
      heli_q8_B.Sum;
   ...
   */
  heli_q8_B.Gain_e = (heli_q8_P.ElevationTransferFcn_C *
                      heli_q8_X.ElevationTransferFcn_CSTATE +
                      heli_q8_P.ElevationTransferFcn_D *
                      heli_q8_B.ElevationCounttorad) * heli_q8_P.Gain_Gain_p;
   ...
   *  Sum: '<S7>/Sum'
   */
  rtb_Backgain = ((rtb_Frontgain + heli_q8_B.K_ep) - heli_q8_P.Gain1_Gain_o *
                  heli_q8_B.Gain_e * heli_q8_P.K_ed_Gain) + heli_q8_B.Constant;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  rtb_Frontgain = (rtb_Sum1 + rtb_Backgain) * heli_q8_P.Frontgain_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S7>/K_ei' */
    heli_q8_B.K_ei = heli_q8_P.K_ei_Gain * rtb_DeadZoney;

    /* Gain: '<S18>/Gain' */
    heli_q8_B.Gain_k = heli_q8_P.Gain_Gain_k * heli_q8_B.TravelCounttorad;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Sum1 = (rtb_Backgain - rtb_Sum1) * heli_q8_P.Backgain_Gain;

  /* Saturate: '<S3>/Back motor: Saturation' */
  if (rtb_Sum1 > heli_q8_P.BackmotorSaturation_UpperSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (rtb_Sum1 < heli_q8_P.BackmotorSaturation_LowerSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q8_B.BackmotorSaturation = rtb_Sum1;
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1490246610U);
  heli_q8_M->Sizes.checksums[1] = (1678238225U);
  heli_q8_M->Sizes.checksums[2] = (4149903922U);
  heli_q8_M->Sizes.checksums[3] = (961583234U);
...

  {
    ...
    heli_q8_B.Sum1 = 0.0;
    heli_q8_B.Gain1_d = 0.0;
    heli_q8_B.Gain_c = 0.0;
