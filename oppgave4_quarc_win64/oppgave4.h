 ...
 */
#ifndef RTW_HEADER_oppgave4_h_
#define RTW_HEADER_oppgave4_h_
#include <string.h>
#ifndef oppgave4_COMMON_INCLUDES_
# define oppgave4_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* oppgave4_COMMON_INCLUDES_ */

#include "oppgave4_types.h"
...
#define oppgave4_rtModel               RT_MODEL_oppgave4_T
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_n;         /* '<S4>/Integrator2' */
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_n;      /* '<S4>/Integrator2' */
...
#define rtB                            oppgave4_B
#define BlockIO                        B_oppgave4_T
#define rtX                            oppgave4_X
#define ContinuousStates               X_oppgave4_T
#define rtXdot                         oppgave4_XDot
#define StateDerivatives               XDot_oppgave4_T
#define tXdis                          oppgave4_XDis
#define StateDisabled                  XDis_oppgave4_T
#define rtP                            oppgave4_P
#define Parameters                     P_oppgave4_T
#define rtDWork                        oppgave4_DW
#define D_Work                         DW_oppgave4_T

/* Parameters (auto storage) */
struct P_oppgave4_T_ {
...
extern P_oppgave4_T oppgave4_P;

/* Block signals (auto storage) */
extern B_oppgave4_T oppgave4_B;

/* Continuous states (auto storage) */
extern X_oppgave4_T oppgave4_X;

/* Block states (auto storage) */
extern DW_oppgave4_T oppgave4_DW;
...
extern void oppgave4_initialize(void);
extern void oppgave4_output0(void);
extern void oppgave4_update0(void);
extern void oppgave4_output(int_T tid);
extern void oppgave4_update(int_T tid);
extern void oppgave4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_oppgave4_T *const oppgave4_M;
 ...
 *
 * '<Root>' : 'oppgave4'
 * '<S1>'   : 'oppgave4/Conversion'
 * '<S2>'   : 'oppgave4/Heli 3D'
 * '<S3>'   : 'oppgave4/Joystick'
 * '<S4>'   : 'oppgave4/LQR'
 * '<S5>'   : 'oppgave4/Observer'
 * '<S6>'   : 'oppgave4/rearrangement of states'
 * '<S7>'   : 'oppgave4/Heli 3D/Degrees to Radians'
 * '<S8>'   : 'oppgave4/Heli 3D/Degrees to Radians1'
 * '<S9>'   : 'oppgave4/Heli 3D/Degrees to Radians2'
 * '<S10>'  : 'oppgave4/Heli 3D/Degrees to Radians3'
 * '<S11>'  : 'oppgave4/Heli 3D/Degrees to Radians4'
 * '<S12>'  : 'oppgave4/Heli 3D/Degrees to Radians5'
 * '<S13>'  : 'oppgave4/Heli 3D/Elevation rad to deg'
 * '<S14>'  : 'oppgave4/Heli 3D/Elevation rate rad to deg'
 * '<S15>'  : 'oppgave4/Heli 3D/Pitch rad to deg'
 * '<S16>'  : 'oppgave4/Heli 3D/Pitch rate rad to deg'
 * '<S17>'  : 'oppgave4/Heli 3D/Travel rad to deg'
 * '<S18>'  : 'oppgave4/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_oppgave4_h_ */
