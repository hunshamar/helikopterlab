...
MODEL                = saman
MODULES              = rtGetInf.c rtGetNaN.c rt_nonfinite.c saman_data.c saman_main.c 
MAKEFILE             = saman.mk
...
MODELLIB                  = samanlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = saman_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)saman_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)sammenlikne
