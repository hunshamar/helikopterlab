 ...
 */
#ifndef RTW_HEADER_saman_h_
#define RTW_HEADER_saman_h_
#include <string.h>
#ifndef saman_COMMON_INCLUDES_
# define saman_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* saman_COMMON_INCLUDES_ */

#include "saman_types.h"
...
#define saman_rtModel                  RT_MODEL_saman_T
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_n;         /* '<S6>/Integrator2' */
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_n;      /* '<S6>/Integrator2' */
...
#define rtB                            saman_B
#define BlockIO                        B_saman_T
#define rtX                            saman_X
#define ContinuousStates               X_saman_T
#define rtXdot                         saman_XDot
#define StateDerivatives               XDot_saman_T
#define tXdis                          saman_XDis
#define StateDisabled                  XDis_saman_T
#define rtP                            saman_P
#define Parameters                     P_saman_T
#define rtDWork                        saman_DW
#define D_Work                         DW_saman_T
...
struct P_saman_T_ {
  ...
  real_T Gain1_Gain_c;                 /* Expression: pi/180
                                        ...
                                        */
  real_T Constant_Value_i;             /* Expression: 6.7
  ...
  real_T Frontgain_Gain;               /* Expression: 0.5
                                        ...
                                        */
  real_T Constant1_Value;              /* Expression: 4.8
  ...
  real_T Gain1_Gain_a;                 /* Expression: pi/180
                                        ...
                                        */
  real_T Gain1_Gain_nh;                /* Expression: pi/180
...
extern P_saman_T saman_P;

/* Block signals (auto storage) */
extern B_saman_T saman_B;

/* Continuous states (auto storage) */
extern X_saman_T saman_X;

/* Block states (auto storage) */
extern DW_saman_T saman_DW;
...
extern void saman_initialize(void);
extern void saman_output0(void);
extern void saman_update0(void);
extern void saman_output(int_T tid);
extern void saman_update(int_T tid);
extern void saman_terminate(void);

/* Real-time Model object */
extern RT_MODEL_saman_T *const saman_M;
 ...
 * '<S5>'   : 'saman/Subsystem1'
 * '<S6>'   : 'saman/Subsystem2'
 * '<S7>'   : 'saman/Heli 3D/Degrees to Radians'
 * '<S8>'   : 'saman/Heli 3D/Degrees to Radians1'
 * '<S9>'   : 'saman/Heli 3D/Degrees to Radians2'
 * '<S10>'  : 'saman/Heli 3D/Degrees to Radians3'
 * '<S11>'  : 'saman/Heli 3D/Degrees to Radians4'
 * '<S12>'  : 'saman/Heli 3D/Degrees to Radians5'
 * '<S13>'  : 'saman/Heli 3D/Elevation rad to deg'
 * '<S14>'  : 'saman/Heli 3D/Elevation rate rad to deg'
 * '<S15>'  : 'saman/Heli 3D/Pitch rad to deg'
 * '<S16>'  : 'saman/Heli 3D/Pitch rate rad to deg'
 * '<S17>'  : 'saman/Heli 3D/Travel rad to deg'
 * '<S18>'  : 'saman/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_saman_h_ */
